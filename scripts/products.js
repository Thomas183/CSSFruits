...
const products = [
    {id: 0, name: 'Carotte', price: 1, img: '../src/img/products/carrot.png'},
    {id: 1, name: 'Pomme', price: 1.50, img: '../src/img/products/apple.png'},
    {id: 2, name: 'Banane', price: 3, img: '../src/img/products/banana.png'},
    {id: 3, name: 'Tomate', price: 1.75, img: '../src/img/products/tomato.png'},
    {id: 4, name: 'Orange', price: 2, img: '../src/img/products/orange.png'},
    {id: 5, name: 'Aubergine', price: 1.25, img: '../src/img/products/eggplant.png'},
    {id: 6, name: 'Raisin', price: 3.50, img: '../src/img/products/grapes.png'},
    {id: 7, name: 'Kiwi', price: 4, img: '../src/img/products/kiwi.png'},
    {id: 8, name: 'Onion', price: 0.50, img: '../src/img/products/onion.png'}
]
